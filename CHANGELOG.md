...
## [1.0.1] - 2026-03-11
### Fixed
- Copy progress bar not working/appearing for files due to useEffect constantly re-checking for existing exports and resetting progress state as if file already fully copied.
